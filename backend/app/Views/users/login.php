    ...
    <div class="flex md:flex-row flex-col shadow-2xl rounded-3xl w-full max-w-6xl overflow-hidden">
        ...
        <div class="flex flex-col md:flex-1 justify-center p-10"
            ...
            <form class="flex flex-col gap-4" action="/login" method="post">
                <input type="text" name="email" placeholder="Email" class="bg-[#1b1b1b] px-4 py-2 border border-[var(--secondary)] rounded-lg focus:outline-none text-[var(--neutral)]">
                <input type="password" name="password" placeholder="Password" class="bg-[#1b1b1b] px-4 py-2 border border-[var(--secondary)] rounded-lg focus:outline-none text-[var(--neutral)]">

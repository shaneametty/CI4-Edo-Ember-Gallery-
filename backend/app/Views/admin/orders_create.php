...
<body class="bg-[var(--accent)] font-sans text-[var(--neutral)]">
            ...
            <form id="createOrderForm" onsubmit="handleCreateOrder(event)">
                <div class="gap-6 grid md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" name="user_id" value="" class="bg-[var(--accent)] px-4 py-3 border border-[var(--secondary)]/30 focus:border-[var(--secondary)] rounded-lg focus:outline-none w-full text-[var(--neutral)] transition" placeholder="Enter user ID" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="product_id" value="" class="bg-[var(--accent)] px-4 py-3 border border-[var(--secondary)]/30 focus:border-[var(--secondary)] rounded-lg focus:outline-none w-full text-[var(--neutral)] transition" placeholder="Enter product ID" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="quantity" value="1" class="bg-[var(--accent)] px-4 py-3 border border-[var(--secondary)]/30 focus:border-[var(--secondary)] rounded-lg focus:outline-none w-full text-[var(--neutral)] transition" min="1" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="total_price" value="" step="0.01" class="bg-[var(--accent)] px-4 py-3 border border-[var(--secondary)]/30 focus:border-[var(--secondary)] rounded-lg focus:outline-none w-full text-[var(--neutral)] transition" placeholder="0.00" required>
                    </div>
    ...
    <script>
        function handleCreateOrder(event) {
            ...
            // Placeholder: add your JS logic to submit the order
